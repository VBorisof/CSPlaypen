...
namespace Entities
{
	...
	{
		public static Schema _SCHEMA = Schema.Parse("{\"type\":\"record\",\"name\":\"User\",\"namespace\":\"Entities\",\"fields\":[{\"name\":\"name\",\"t" +
				"ype\":\"string\"},{\"name\":\"favorite_number\",\"type\":[\"int\",\"null\"]},{\"name\":\"favorit" +
				"e_color\",\"type\":[\"string\",\"null\"]}]}");
